defmodule Livebook.Runtime.ErlDist.RuntimeServer do
  ...
  def handle_intellisense(pid, send_to, request, parent_locators, node, metadata) do
    ref = make_ref()

    GenServer.cast(
      pid,
      {:handle_intellisense, send_to, ref, request, parent_locators, node, metadata}
    )
  ...
  def handle_cast(
    ...
    Task.Supervisor.start_child(state.task_supervisor, fn ->
      ...
      response =
        Livebook.Intellisense.handle_request(request, intellisense_context, node, metadata)
